 ...
 */
export function buildReportHtmlDetailed({ filename, ext, policy, cleaning, correction, analysis }) {
  ...
  const correctionRows = (correction?.examples || []).map(({before, after}) =>
    `<tr>
      <td class="cell-before"><div class="code-block">${escapeHtml(before)}</div></td>
  ...
  <div class="container">
    ...
    <div class="score-card">
      ...
      <div class="score-stats">
        ...
        <div class="score-stat">
          <div class="score-stat-number">${fmt(correction?.changedTextNodes) || 0}</div>
