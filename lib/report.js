// lib/report.js
// Génère un rapport HTML professionnel pour Qualion-Doc - v2.3 FINAL
...
export function buildReportHtmlDetailed({ filename, ext, policy, cleaning, correction, analysis, spellingErrors = [] }) {
  ...
  // Helper pour ajouter une correction sans doublon
  ...
  // 1. Ajouter les spellingErrors (plusieurs formats possibles)
...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Corrections Table - DESIGN AMÉLIORÉ */
    .corrections-table {
      width: 100%;
